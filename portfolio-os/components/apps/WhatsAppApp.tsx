...
const BOT: Record<string, string[]> = {
  ...
  about: ["BIT student in Kathmandu, AI Growth Intern at Springbase AI, building AI infrastructure for people the industry skips. Built this whole desktop with Claude Code."],
  who: ["BIT student in Kathmandu, AI Growth Intern at Springbase AI, building AI infrastructure for people the industry skips. Built this whole desktop with Claude Code."],
  thanks: ["Anytime! ✌️"],
  ok: ["👌"],
